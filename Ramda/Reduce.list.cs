// <autogenerated>
//   This file was generated by T4 code generator Reduce.list.tt.
...
namespace Ramda.NET
{
	...
	{	
		...
		/// <see cref="R.AddIndex"/>
		/// <see cref="R.Reduce"/>
		public static dynamic Reduce<TSource, TReturn, TAccmulator>(Func<TSource, TAccmulator, TReturn> fn, TAccmulator acc, IList<TSource> list) {
		...
		/// <see cref="R.AddIndex"/>
		/// <see cref="R.Reduce"/>
		public static dynamic Reduce<TSource, TReturn, TAccmulator>(Func<TSource, TAccmulator, TReturn> fn, RamdaPlaceholder acc, IList<TSource> list) {
			return Currying.Reduce(Delegate(fn), acc, list);
		}
		...
		/// <see cref="R.AddIndex"/>
		/// <see cref="R.Reduce"/>
		public static dynamic Reduce<TSource, TReturn, TAccmulator>(Func<TSource, TAccmulator, TReturn> fn, RamdaPlaceholder acc = null, RamdaPlaceholder list = null) {
			return Currying.Reduce(Delegate(fn), acc, list);
		}
