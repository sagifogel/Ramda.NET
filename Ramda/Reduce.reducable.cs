// <autogenerated>
//   This file was generated by T4 code generator Reduce.reducable.tt.
...
namespace Ramda.NET
{
	...
	{	
		...
		/// <see cref="R.AddIndex"/>
		/// <see cref="R.Reduce"/>
		public static dynamic Reduce<TSource, TReturn, TAccmulator>(Func<TSource, TAccmulator, TReturn> fn, TAccmulator acc, IReducible list) {
		...
		/// <see cref="R.AddIndex"/>
		/// <see cref="R.Reduce"/>
		public static dynamic Reduce<TSource, TReturn, TAccmulator>(Func<TSource, TAccmulator, TReturn> fn, TAccmulator acc, RamdaPlaceholder list = null) {
			return Currying.Reduce(Delegate(fn), acc, list);
		}
